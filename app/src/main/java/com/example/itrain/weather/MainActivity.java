package com.example.itrain.weather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FunctionActivity.placeIdTask asyncTask =new FunctionActivity.placeIdTask(new FunctionActivity.AsyncResponse() {
        ...
        asyncTask.execute("2.982930", "101.667286");
